...
class App {
    constructor(port) {
        ...
        app.use('/jsm/geometries/BoxLineGeometry', express_1.default.static(path_1.default.join(__dirname, '../../node_modules/three/examples/jsm/BoxLineGeometry/BoxLineGeometry.js')));
        app.use('/jsm/webxr/XRControllerModelFactory', express_1.default.static(path_1.default.join(__dirname, '../../node_modules/three/examples/jsm/webxr/XRControllerModelFactory.js')));
        app.use('/jsm/libs/motion-controllers.module.js', express_1.default.static(path_1.default.join(__dirname, '../../node_modules/three/examples/jsm/libs/motion-controllers.module.js')));
